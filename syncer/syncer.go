...
//
//    // Step 1: Pull the image from the source repository
...
//    }
//
//    // Step 2: Tag the image for the target repository
...
//    }
//
//    // Step 3: Push the image to the target repository
...
//    maxConcurrency := 20  // 最大并发数，可以根据需要调整
